           ...
           # print(qqwp)
            ...
            while ao<qqwp:
                 ...
                 if qq==1:
                     ...
                     szxxa=bitblockone01w1[10:30]
                     szxxa2=bitblockone01w1[10:]
                 ...
                 if tranbd==qq:
                     if qq>1:
                         eo=ao-30
                         ao=ao-30
                     b2=bitblockone0w2+szxxa+bitblockone01w1
                     
                     #print(b2)
                     #os.system("pause")
                     wer=wer+b2
                 else:
                     if qtqweq2[10:30]==szxxa and qq<=65535:
                         
                         #print(ao)
                         #print(eo)
                         
                         b3=qtqweq2[0:10]+szxxa2
                         #print(b3)
                         #)os.system("pause"
                         wer=wer+b3
                         #print(b3)
                ...
                for byte in sda:
                    ...
                    if a == blockw:
                        ...
                        if blockw==4:
                             ...
                             if szxx[10:30]==szxxa and assa<=65535:
                                qqw1q="10"
                                #print(szxxa2)    
                                ...
                                asaaq=asaaq+qqqs
                             elif szxx[10:]==szxxa2 and assa<=65535:
                                 print(szxxa2)
                                 wer=wer+szxx[0:10]+szxxa
